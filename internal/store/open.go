...
func (s *GormStore) Migrate(ctx context.Context) error {
	...
	if err := s.db.WithContext(ctx).AutoMigrate(&SpendRecord{}, &User{}, &CacheMetric{}, &HiveStateMetric{}, &TenantSettings{}, &KeyRouteSettings{}, &FeedbackRecord{}, &ProviderFile{}, &StoredResponse{}, &StoredConversation{}, &StoredConversationItem{}, &KeyEvent{}, &SpendDailySummary{}, &TraceEvent{}, &TraceSession{}, &WatchlistTerm{}, &DetectorSetting{}, &FirewallRule{}); err != nil {
		return err
	}
